...
public class TeleOpTesting11691 extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(gamepad1.right_bumper)           {SK_Grab_Right.goToClawPreGrabPosition(); }
            if(gamepad1.dpad_right)             {SK_Grab_Right.carryStone(); }
            if(gamepad1.dpad_left)              {SK_Grab_Left.carryStone(); }
            ...
            if(gamepad1.left_bumper || gamepad1.right_bumper)            { slow  = 0.4;} else { slow = 1;}        //Intake In Position
